...
\begin{itemize}
	...
	\item \textbf{Åtgärdscentret (Security and Maintenance):} Det heter inte 'åtgärdscentret' längre i windows 10. Namnet byttes till 'säkerhet och underhåll', eller så som alla ser det egentligen: 'security and maintenance'. % TODO inte färdig
\end{itemize} 
