...
Vi kan testa skapa en modell som beskriver ett bankkonto med ränta. Vi låter $f(x)$ benämna bankkontots innehåll i kr, och $x$ vara tiden i år. Vi låter startvärdet, vid år 0, vara 10 000 kr.
\begin{align*}
	f(x)=Ca^x \\
	f(0)=Ca^0 = C = 10000
\end{align*}
